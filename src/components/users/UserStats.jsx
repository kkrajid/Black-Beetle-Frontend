...
export function UserStats({ stats }) {
  ...
  const statItems = [
    ...
    {
      title: "B2B Admins",
      value: stats.b2bAdmins,
      icon: UserCheck,
      description: "Institution administrators",
      trend: stats.b2bAdminsTrend,
    },
    {
      title: "B2B Users",
      value: stats.b2bUsers,
      icon: Building2,
      description: "Institution members",
      trend: stats.b2bUsersTrend,
    },
    {
      title: "B2C Users",
      value: stats.b2cUsers,
      icon: User,
      description: "Individual users",
      trend: stats.b2cUsersTrend,
    }
  ];
